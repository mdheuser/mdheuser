...
## Featured work
- **video pipeline tool** – a tool (Bash/Python, ffmpeg, Tesseract) that turns random still images into a video.
...
C/C++, Unix, Git, debugging, Docker fundamentals, REST API design, SQL basics, TypeScript/Node fundamentals.
